...
html=$("html"),body=$("body"),main=$("main"),section=$("section"),article=$("article"),footer=$("footer"),preloader=$("#preloader"),navbarToggle=$("#navbar-toggle"),navPanelToggle=$("#nav-panel-toggle"),navToggle=$(".nav-toggle"),navToggleLabel=$(".nav-toggle-label"),navbar=$("#navbar"),navItems=$(".nav-items"),toolbar=$("#toolbar"),toolbarMenubar=$("#toolbar .menubar"),toolbarContents=$("#toolbar-contents"),toolbarItems=$("#toolbar-items nav > ul > li"),navPanel=$("#nav-panel"),navPanelMenubar=$("#nav-panel .menubar"),navPanelContents=$("#nav-panel-contents"),navPanelItems=$("#nav-panel-items > ul > li"),navPanelLogo=$("#nav-panel-logo"),navPanelCallout=$("#nav-panel-callout"),panelOverlay=$(".js-off-canvas-overlay");var $usePreloader=!(navPanelString="#nav-panel"),$showPrivacyPolicy=!0,$navbarHeight="150px",$navbarShrinkHeight="75px",$navbarShowOnPageEndHeight="75px",$toolbarHeight="75px",$toolbarShrinkHeight="100%",$toolbarShowOnPageEndHeight="75px",$allowScrollTo=!0,$scrollToSpeed=1,$scrollToOffsetY=50,$scrollToEase=Power4.easeInOut,$delayInterval=1,$updateInterval=100,$throttleTrail=!0,$throttleLeading=!0,stickyAnchor="",$stickyAnchorTolerance=0,$navbarAllowSticky=!0,$navbarStickyClass="sticky",$stickyOffset=0,$stickyScrollToleranceUp=0,$stickyScrollToleranceDown=0,$navbarShrinkSpeed=.5,$navbarShrinkEase=Power4.easeOut,$navbarHideOnScrollUp=!1,$navbarHideOnScrollDown=!0,$navbarShowOnPageEnd=!0,$navbarHideSpeed=1,$navbarHideEase=Power4.easeOut,$toolbarShowOnMobileOnly=!1,$toolbarShrinkSpeed=.5,$toolbarShrinkEase=Power4.easeOut,$toolbarHideOnScrollUp=!1,$toolbarHideOnScrollDown=!1,$toolbarShowOnPageStart=!1,$toolbarShowOnPageEnd=!0,$toolbarHideSpeed=.25,$toolbarHideEase=Power4.easeOut,$useNavPanelAnimation=!0,$navPanelPosition="top",$navPanelTransitionSpeed="0.5s",$navPanelTransitionEase="InOut",$navPanelCloseOnLinkClick=!0,$navPanelItemsClass="",$panelOverlayTransitionSpeed=1,$panelOverlayDelay=1,$contentOpacity=1,$contentScale=1,$contentSpeed=.2,$contentEase=Power4.easeOut;
...
var page=$(".page").data("page"),linkHome=$(".link-home"),pages=function(){"use strict";"index"===page&&linkHome.addClass("active")};
